...
//// Model for second phase parameterization. Implementtatioin for annual species (mortality = 1)
...
Type objective_function<Type>::operator() ()
{
    ...
    DATA_INTEGER(DD); //mortality (D)

    //Parameters
    PARAMETER(theta);   //parameter for negative binomial
    ...
    //Individuals that successfully disperse
